export default function MailIcon({ name = 'mail', size = 18 }) {
  const paths = {
    ...
    trash: <><path d="M4 7h16" /><path d="M10 11v5M14 11v5M6 7l1 13h10l1-13M9 7V4h6v3" /></>,
    menu: <><path d="M4 7h16M4 12h16M4 17h16" /></>,
    filter: <path d="M4 5h16l-6 7v5l-4 2v-7L4 5Z" />,
    refresh: <><path d="M20 11a8 8 0 0 0-14-4L4 9" /><path d="M4 5v4h4M4 13a8 8 0 0 0 14 4l2-2" /><path d="M20 19v-4h-4" /></>,
  ...
  return <svg aria-hidden="true" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">{paths[name] || paths.mail}</svg>;
}
